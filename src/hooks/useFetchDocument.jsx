...
export const useFetchDocument = (docCollection, search = null, uid = null) => {
  ...
  const getDateAndHours = (dateDoc) => {
    ...
    // const newDateAtual = dataAtual.toLocaleDateString("pt-BR", {
    //   year: "numeric",
    //   month: "long",
    //   day: "numeric",
    //   hour: "numeric",
    ...
    //   "Teste de data!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    // );
    // console.log(Math.floor(differenceInMinutes), "minutos");
    // console.log(Math.floor(differenceInHours), "horas");
